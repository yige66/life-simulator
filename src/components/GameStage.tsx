...
const NARRATIVE_STAT_KEYS: Record<keyof Stats, RegExp> = {
  智力: /智[力慧]|推理|逻辑|记忆|思维|头脑|分析|思考|灵机|灵光|判断|洞察|豁然开朗|新发现|真谛|好奇/,
  魅力: /魅[力惑]|吸引|气质|风[采度]|人[缘脉]|口才|谈吐|亲和|交[谈流际]|迷人|称赞|赞赏|赞许|倾倒|好感|信[任赖]/,
  体力: /体[力能]|力[气量]|身[体躯]|强壮|坚[韧固]|战斗|伤[痛势口]|受伤|重伤|疲惫|疲劳|虚[弱]|累倒|透支|体魄|体术|肌肉|硬扛|奔跑|挽回|困倦|精力|恐惧|噩梦|苦果|代价|隐[隐痛]/,
  运气: /运[气势]|幸[运好]|巧合|偶然|机缘|命运|奇迹|天选|倒霉|不幸|意外|厄运|奇遇|好运|坏运|偶然/,
};
...
const NARRATIVE_UP   = /上升|增强|增加|提升|增长|强化|恢复|进步|飞跃|高涨|变强|觉醒|成功|获得|领悟|吸引|奇迹|天选|机缘|亲和|口才|谈吐|挽回|痊愈|好转|消散|消失|恢复|愈合|消除|终结|消散|退散|加速|敬[畏佩]|求[教助]|追随|倾倒|称赞|赞赏|赞许|出奇|好[转了]|奇遇|治疗|救治|爆发|膨胀|掌控|冲天|绽放|涌动|碾压|主宰|骇人|威慑|征服|力压/;
...
★ 体力铁律（AI每次判定前必须默念）：
  体力 = 战斗力，是力量、气势、威慑力与身体状态（含伤势、体力储备）的综合体现。
  体力高 = 战力强横不可撼动，浑身充盈力量；体力低 = 战力孱弱，伤痕累累或气力耗尽。
  受伤 / 流血 / 身体负伤 → 体力↓（伤势拖累战力）；但体力值归零 ≠ 死亡，只代表失去战斗能力。
  stamina变化可源于力量/气势/威慑/身体状态变化，描述可包含"伤势""伤口""力竭"等词汇。
...
★ effectsSummary 铁律：
  ...
  - 体力铁律：stamina=战斗力，受力量/气势/威慑/伤势综合影响，归零=失去战力≠死亡。
...
★ 自定义动作特殊规则：
  - 必须先评估该行动在角色身份背景、世界观、当前属性下是否合理可行。
  - 若角色是普通人（属性=1~3、背景平凡），自称神迹、突破次元等离谱行动应判定为妄想，叙事中角色尝试但毫无效果或遭遇嘲讽，effectsSummary 必须为空字符串 ""。
  - 若角色背景强大（如创世神、万界主宰,影之实力者）等能力极强的人物或属性极高（≥10），行动可合理生效，叙事照常描写结果。
  - 若角色的自定义行动中明示了具体的属性名和数值（如"智力暴增999"），且角色背景足够强大，才可在 effectsSummary 中体现相应的大幅度变化。
  - 在进行以上判断后，再必须生成 narrative 描述该动作在世界中造成的直接结果。
  - narrative 是纯故事文本。
