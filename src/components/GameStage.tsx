...
★ 体力铁律（每次属性判定前必须默念）：
  体力不是血量/生命值/HP，而是一个人的「战斗力」——力量、气势、威慑力、战斗能力的总和。
  体力高 = 战力强横不可撼动；体力低 = 战力孱弱不堪一击。
  受伤 → 体力↓（战力下降）；但体力值与血量无关，不存在"体力耗尽=死亡"的逻辑。
  体力变化描述应为"力量涌动""气势攀升""战力衰退""威慑尽失"等战斗力词汇，不应出现"失血""伤势加重"等血量词汇。
...
★ effectsSummary 铁律：
  ...
  - 体力铁律重申：stamina变化只源于战斗力描述（力量/气势/威慑），不源于血量描述。
...
★ effectsSummary 铁律：
  ...
  - 叙事中**未提到**的属性，effectsSummary 中**绝不可出现**。
  - 若叙事中只明显体现了一项属性变化迹象，effectsSummary 只包含该属性，不强行添加第二项。
  - 体力铁律：stamina 是战斗力，只反映力量/气势/威慑变化，不反映血量变化。
  - effectsSummary 格式：intelligence:+1, stamina:-2（英文属性名:符号数值，逗号分隔）。
  - 英文属性名只用：intelligence(智力) charm(魅力) stamina(体力) luck(运气)。
  - 数值幅度：±1~±3。
