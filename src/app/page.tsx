      ...
      const res = await fetch('/api/deepseek', {
        ...
        body: JSON.stringify({
          messages: [
            {
              role: 'system',
              content: '你是一个轻小说作家。根据玩家信息写一个感人的结局并给出角色评价。结局呼应世界观和角色身份，字数150-200字。再根据最终属性逐项判定角色类型并融合成一句40-60字的总结。判定标准：\n- 智力≥15→"智者/军师"，智力≤-5→"懵懂者"\n- 魅力≥15→"万人迷"，魅力≤-5→"默默无闻"\n- 体力≥15→"战神"，体力≤-5→"体弱多病"\n- 运气≥15→"天选之人"，运气≤-5→"倒霉蛋"\n- 如果某一项不高不低则该项不提名\n- 四项都≥15为"传奇"，四项都≤-5为"平凡中的奇迹"\n逐项检查，在evaluation中提及所有极端的项。返回JSON：{"ending": "结局文本", "evaluation": "角色总结"}'
            },
            {
              role: 'user',
